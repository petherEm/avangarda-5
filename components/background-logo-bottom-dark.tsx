    ...
    <>
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[#404042] via-[#2a2a2c] to-[#1a1a1c]">
        ...
        <div className="absolute inset-0">
          <div
            className={`hidden sm:block absolute bottom-[2rem] sm:bottom-[3rem] w-[45%] h-[3px] opacity-40 ${
        ...
        <div className="absolute inset-0">
          <div
            className={`absolute bottom-4 w-16 h-16 sm:bottom-10 sm:w-20 sm:h-20 opacity-80 ${
        ...
        {/* Gradient Accent Shapes - Unchanged */}
