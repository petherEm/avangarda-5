            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:h-screen">
              ...
              <div className="md:col-span-5 flex flex-col md:justify-end pb-8 md:pb-16 pt-6 md:pt-0">
                <div className="space-y-4 md:space-y-6">
                  ...
                  {/* Key Features Grid - Now with 6 items */}
                  <div className="grid grid-cols-2 gap-3 sm:gap-4">
                    <div className="flex items-center space-x-2 text-sm">
                      <Gift className="h-5 w-5 text-avangarda flex-shrink-0" />
                      <span className="text-white/90">
                        {lang === "pl" ? "Idealny prezent" : "Perfect gift"}
                      </span>
                    </div>
                    <div className="flex items-center space-x-2 text-sm">
                      <Clock className="h-5 w-5 text-avangarda flex-shrink-0" />
                      <span className="text-white/90">
                        {lang === "pl"
                          ? "Ważny 12 miesięcy"
                          : "Valid 12 months"}
                    ...
                    <div className="flex items-center space-x-2 text-sm">
                      ...
                      <span className="text-white/90">
                        {lang === "pl" ? "Elegancki design" : "Elegant design"}
                      </span>
                    </div>
                    <div className="flex items-center space-x-2 text-sm">
                      <CreditCard className="h-5 w-5 text-avangarda flex-shrink-0" />
                      <span className="text-white/90">
                        {lang === "pl" ? "Łatwy zakup" : "Easy Purchase"}
                      </span>
                    </div>
                    <div className="flex items-center space-x-2 text-sm">
                      <Gift className="h-5 w-5 text-avangarda flex-shrink-0" />
                      <span className="text-white/90">
                        {lang === "pl" ? "Personalizacja" : "Personalization"}
                      </span>
                    </div>
                    <div className="flex items-center space-x-2 text-sm">
                      <Shield className="h-5 w-5 text-avangarda flex-shrink-0" />
                      <span className="text-white/90">
                        {lang === "pl" ? "Gwarancja" : "Guarantee"}
                      </span>
                    </div>
                  </div>
